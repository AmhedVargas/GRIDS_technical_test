...
#
##What about if I asume a pop larger than 50
plot(1:20,MedRes[c(1:20)],type="l",col="black", main="Novel SNPs per genome sequenced")
points(1:20,c(MedRes[1:20] + SdRes[1:20]),col="red")
points(1:20,c(MedRes[1:20] - SdRes[1:20]),col="blue")
...
plot(1:20,MedRes[c(1:20)],type="l",col="black", main="Novel SNPs per genome sequenced",ylab="Novel SNP count")
points(1:20,c(MedRes[1:20] + SdRes[1:20]),col="red")
points(1:20,c(MedRes[1:20] - SdRes[1:20]),col="blue")

lines(as.integer(names(Seens)),as.integer(Seens),col = "red")

plot(2:20,MedRes[c(2:20)],type="l",col="black", main="Novel SNPs per genome sequenced",ylab="Novel SNP count",xlab="Individual seen")
points(2:20,c(MedRes[2:20] + SdRes[2:20]),col="red")
points(2:20,c(MedRes[2:20] - SdRes[2:20]),col="blue")

lines(as.integer(names(Seens)),as.integer(Seens),col = "red")

legend("top",c("Median bootstrap", "Expected frequency"), col=c("black","red"),pch = 18)
max(Seens)
